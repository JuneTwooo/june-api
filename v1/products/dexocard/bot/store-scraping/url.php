            ...
            */
            ...
            // Création requête SQL
               ...
               "
                  ...
                  `" . $_TABLE_LIST['dexocard'] . "`.`store_url`.`store_url_javascript_container`,
                  `" . $_TABLE_LIST['dexocard'] . "`.`store_url`.`store_url_javascript_name`,
                  `" . $_TABLE_LIST['dexocard'] . "`.`store_url`.`store_url_javascript_link`,
                  `" . $_TABLE_LIST['dexocard'] . "`.`store_url`.`store_url_javascript_image`,
                  `" . $_TABLE_LIST['dexocard'] . "`.`store_url`.`store_url_javascript_price`,
                  `" . $_TABLE_LIST['dexocard'] . "`.`store_url`.`store_url_javascript_stock`,
            ...
            // Formatage des données envoyées
               ...
               )->fetchAll(PDO::FETCH_ASSOC) as $thisCard)
               {
                  ...
                  (
                     ...
                     'javascript_container'     => $thisCard['store_url_javascript_container'],
                     'javascript_name'          => $thisCard['store_url_javascript_name'],
                     'javascript_link'         => $thisCard['store_url_javascript_link'],
                     'javascript_image'         => $thisCard['store_url_javascript_image'],
                     'javascript_price'         => $thisCard['store_url_javascript_price'],
                     'javascript_stock'         => $thisCard['store_url_javascript_stock'],
